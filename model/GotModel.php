	...
	*/
	class GotModel	{
		...
		function InsertEpisode($db, $tabNam){
			...
			(1, 10, Tras la ejecución de Ned, los norteños proclaman a Robb como su rey. Con Jaime capturado por los Stark, Lord Tywin Lannister asigna a su hijo Tyrion como Mano del Rey para mantener a Joffrey y Cersei bajo control. Jon abandona su puesto en el
				Muro para vengar a su padre, pero sus amigos lo persiguen y lo convencen para quedarse. La Guardia de la Noche parte a una expedición más allá del Muro. El hijo nonato de Daenerys muere y Drogo se encuentra en estado vegetativo debido a la
				magia de la maegi traidora. Incapaz de soportar la ruina de su marido, Daenerys termina con su vida y prepara una pira funeraria en la que quema a la maegi viva junto con el cuerpo de Drogo y sus tres huevos de dragón. Además, ella misma entra
				en la pira y cuando esta se apaga Daenerys se eleva, sana y salva, flanqueada por tres dragones recién nacidos.'),
