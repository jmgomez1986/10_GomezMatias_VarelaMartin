 ...
 */
  ...
  class TemporadasView
  {
    ...
    function MostrarTemporadas($temporadas, $episodios ,$link, $script, $claseLogin, $claseLogout){
    ...
    function MostrarEditarTemporada($titulo, $temporada, $link, $script, $claseLogin, $claseLogout){
    ...
    function MostrarEpisodios($episodios, $link, $script, $claseLogin, $claseLogout){
      $this->Smarty->assign('episodios',$episodios);
      $this->Smarty->assign('link',$link);
      $this->Smarty->assign('script', $script);
      $this->Smarty->assign('claseLogin', $claseLogin);
    ...
    function MostrarEpisodio($episodio, $link, $script, $claseLogin, $claseLogout){
    ...
    function MostrarEditarEpisodio($titulo, $episodio, $link, $script, $claseLogin, $claseLogout){
    ...
    function MostrarAgregarEpisodio($titulo, $id_temporada, $valoresEpisodio, $link, $script, $claseLogin, $claseLogout){
      $this->Smarty->assign('titulo',$titulo);
    ...
    function AdminTools($temporadas, $temporadasID, $episodios, $link, $script, $claseLogin, $claseLogout){
      $this->Smarty->assign('temporadas',$temporadas);
    ...
    function MostrarAgregarTemporada($titulo, $valoresTemporada, $link, $script, $claseLogin, $claseLogout){
      $this->Smarty->assign('titulo',$titulo);
      $this->Smarty->assign('link', $link);
      $this->Smarty->assign('script', $script);
      $this->Smarty->assign('claseLogin', $claseLogin);
