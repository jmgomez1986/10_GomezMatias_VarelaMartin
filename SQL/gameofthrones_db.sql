...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 05-11-2018 a las 01:15:16
...
(2, 1, 1, 1, 'Test Comentario - 02', 5),
(3, 1, 1, 3, 'Test Comentario - 03', 4),
(4, 1, 1, 3, 'Test Comentario - 04', 4),
(5, 1, 1, 2, 'Test Comentario - 05', 4);
...
INSERT INTO `episode` (`id_season`, `id_episode`, `episode_title`, `episode_desc`, `imagen`) VALUES
...
(1, 11, 'Test Upload Image', 'Test', 'images/episodes/5bdf8b5b23c19.jpg'),
...
--
DELIMITER $$
CREATE TRIGGER `updateSeasonDel` AFTER DELETE ON `episode` FOR EACH ROW BEGIN
													UPDATE season SET cant_episodes = cant_episodes-1 WHERE id_season = OLD.id_season;
												END
$$
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `updateSeasonIns` AFTER INSERT ON `episode` FOR EACH ROW BEGIN
...
INSERT INTO `user_info` (`id_user`, `user_name`, `user_password`, `user_email`, `user_rol`) VALUES
